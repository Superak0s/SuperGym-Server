...
router.post(
  ...
  async (req: Request, res: Response) => {
    ...
    try {
      friendshipId = await sendFriendRequest(req.user!.id, targetUser.id)
    } catch (err) {
...
router.post(
  ...
  async (req: Request, res: Response) => {
    ...
    try {
      ...
      if ((err as Error).message === "Friend request not found")
...
router.delete(
  ...
  async (req: Request, res: Response) => {
    ...
    try {
      ...
      if ((err as Error).message === "Friendship not found")
